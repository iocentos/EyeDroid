...
public abstract class OutputNetProtocol implements IOProtocolWriter {
	...
	protected final OutputNetProtocolController mController; // Message
																// controlle
	public Object lock; // Lock used to provide atomic access to sampled
						// coordinates
	...
	/**
	 * Send coordinates to client along with HMGT or RGT format message. No
	 * mapping is done in this method.
	 * 
	 * @param message
	 *            Message type
	 * @param x
	 ...
	 * @throws IOException
	 */
	protected abstract void sendCoordinates(int message, int x, int y)
			throws IOException;
}
