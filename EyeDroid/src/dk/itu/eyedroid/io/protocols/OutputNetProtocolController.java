 ...
 */
public abstract class OutputNetProtocolController implements CalibrationCallbacks, ExperimentCallbacks {

	protected NETCalibrationController mCalibrationController;	// Calibration controller
	protected NETExperimentController mExperimentController;	// Experiment controller
	...
	public AtomicBoolean isExperimentRunning;					// True when client requested to experiment

	/**
	 * Default constructor
	 * @param calibration Calibration controller
	 */
	public OutputNetProtocolController(NETCalibrationController calibration, NETExperimentController experiment){
