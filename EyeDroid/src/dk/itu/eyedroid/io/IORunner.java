...
public abstract class IORunner extends Thread{
	...
	/**
	 * Initialize redear and writer, then execute them.
	 * If an excpetion is thrown during the initialization of either reader or writer, IO controller is stopped.
	 */
	@Override
	public void run(){
		try {
			...
			//If initialization attempts exceed the maximum allowd, throw exception.
	...
	/**
	 * IORunner initialization implementation.
	 * The method should be used to initialize RW protocols.
	 * @throws IOException
	 */
	public abstract void onInit() throws IOException;
	
	/**
	 * IORunner execution method.
	 * The method should be used to read and write from/to the IO Controller
	 * @throws IOException
	 */
