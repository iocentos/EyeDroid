...
/**
 * Algorithm step: 6
 * After each frame is processed by all the previous steps, the result is a 
 * white image with black blobs in it. This makes it easier for the detection 
 * method to find circles. The method used in this step is the HoughCircles
 * from the OpenCV library, giving as parameters a minimum radius of 20px and 
 * a maximum of 50px.
 */
