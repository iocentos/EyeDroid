...
/**
 * Algorithm step: 7 Finally, because the previous step can detect many circles,
 * the one that is closest to the center of the image is taken as the pupil and
 * the 2-axis coordinates are computed. The location of the detected pupil is
 * used later as feedback to the first algorithm step in order to compute the
 * ROI on subsequent frames.
 */
