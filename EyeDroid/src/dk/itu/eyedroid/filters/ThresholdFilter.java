...
/**
 * Algorithm step: 3
 * Thresholding. The exact type of thresholding used was binary inverted.
 * The result of this operation was a new image where the most dark parts 
 * of the original image were converted to black while the most bright parts 
 * of the image were converted to white. This way the pupil is represented now
 * as a black blob in the image while removing any unnecessary data in the rest 
 * of the image.
 */
