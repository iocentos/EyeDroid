...
public class LogStatistcsLogger implements ProcessingCore.StatisticsCallback{
	...
	public void onStatisticsUpdates(CoreStatistics arg0) {
		...
		String filterHeaders = String.format("Name\t\t\tExecutionTime\t\tCount");
		...
		for (int i = 0 ; i < arg0.filtersCount ; i++ ){
			Log.i(TAG, String.format("%s\t\t\t%2f\t\t%d", arg0.filterNames[i] , arg0.filterExecutionTimes[i] , arg0.filterExecutionCounter[i]));
		}
